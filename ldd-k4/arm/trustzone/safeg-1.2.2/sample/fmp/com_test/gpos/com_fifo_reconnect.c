...
int main(int argc, char *argv[])
{
	...
	printf("This is com_fifo_reconnect.exe %d %d\n", atoi(argv[1]), atoi(argv[2]));
	//fprintf(fp, "This is com_fifo_reconnect.exe\n");
	...
	/* If argv[1] == '0' then return */
	if (!rec_flag){
		printf("argv[2] = '0'. Exit connection.\n");
		//fprintf(fp, "argv[3] = '0'. Exit connection.\n");
		return 0;
	}

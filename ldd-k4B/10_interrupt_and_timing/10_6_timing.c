...
{                                                                                                                                  
	...
	printk("\n ndelay 19999  %ld s .%ld ns",timespec.tv_sec,timespec.tv_nsec);	   
	        
	 ndelay(19999);       
	        
	jiffies_to_timespec(jiffies,&timespec);                                                                                                                                                                                    
	printk("\n udelay 19999  %ld s .%ld ns",timespec.tv_sec,timespec.tv_nsec);	
	
	 udelay(19999);   
	 
	jiffies_to_timespec(jiffies,&timespec);                                                                                                                                                                                    
	printk("\n mdelay 199  %ld s .%ld ns",timespec.tv_sec,timespec.tv_nsec);
	
	
	 mdelay(199);  	
		 
	jiffies_to_timespec(jiffies,&timespec);                                                                                                                                                                                    
	printk("\n mdelay e %ld s .%ld ns",timespec.tv_sec,timespec.tv_nsec);		 
